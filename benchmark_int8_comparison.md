...
serve3_fixed.py uses CT2 with int8_float16 and is 29% faster than serve4.py
...
|--------|---------|-------------|-----------|
| serve3_fixed.py | CTranslate2 | int8_float16 (CT2 native) | CT2 internal |
...
|--------|-------|----------|-----------------|
| serve3_fixed (CT2 int8_fp16) | **136.55s** | **0.54s** | baseline |
...
|--------|-------|-----|-----------------|
| serve3_fixed (CT2 int8_fp16) | **40.34s** | **0.043** | baseline |
...
|--------|-------|----------|
| serve3_fixed (CT2 int8_fp16) | 34.74s | 0.66s |
...
| Long audio (>30s) | **serve3_fixed CT2 int8_fp16** | Native int8 + C++ chunking |
