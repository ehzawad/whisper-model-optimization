# Benchmark: serve3_fixed.py (CT2) vs serve4.py (HF + Flash Attention 2)
...
|--------|---------|-----------|-----------|
| serve3_fixed.py | CTranslate2 (faster-whisper) | `_pipeline.forward()` batched | CT2 internal |
...
|--------|-----------|----------|---------|---------|
| serve3_fixed.py (CT2) | 136.55s | 0.54s | 254/254 | — |
...
|--------|-----------|-----|---------|---------|
| serve3_fixed.py (CT2) | 40.34s | 0.043 | 1/1 | **29% faster** |
...
| Server | Total Time | Per Item | Success | Faster? |
|--------|-----------|----------|---------|---------|
| serve3_fixed.py (CT2) | 34.74s | 0.66s | 53/53 | — |
...
| Single long audio (947s) | **serve3_fixed.py (CT2)** | 29% faster |
